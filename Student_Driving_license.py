...
label_id_tag = canvas.create_text(25,60, font=('Times', '14', 'bold') ,text="19827198349 :")
label_name_tag = canvas.create_text(30,100, font=('Times', '12', 'bold') ,text="Winnie the Pooh :")
label_dob_tag = canvas.create_text(52,120, font=('Times', '12', 'bold') ,text="21 August 1921 :")
label_pin_tag = canvas.create_text(32,140, font=('Times', '12', 'bold') ,text="541478 :")
label_address_tag = canvas.create_text(36,160, font=('Times', '12', 'bold') ,text="Disneyland , Hong Kong :")
